        ...
        <div className="mt-auto pt-4 border-t border-neutral-100 dark:border-neutral-800">
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            {techStack.map((tech, index) => (
              <span
                key={index}
                className="px-1.5 py-0.5 sm:px-2 sm:py-1 text-[9px] sm:text-[10px] font-medium rounded-md text-neutral-500 dark:text-neutral-400 bg-neutral-100 dark:bg-neutral-700/30 uppercase"
              >
                {tech}
              </span>
            ))}
